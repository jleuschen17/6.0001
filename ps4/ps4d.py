...
WORDS_ALL_LOWER = 'abcdefghijklmnopqrstuvwxyz'
WORDS_ALL_UPPER = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
...
class SubMessage(object):
    ...
    def build_transpose_dict(self, permutation):
    	...
    	for x in range(len(permutation)):
    		cipherdict[WORDS_ALL_UPPER[x]] = permutation[x].upper()
    		cipherdict[WORDS_ALL_LOWER[x]] = permutation[x].lower()
    	print(cipherdict)
    	return cipherdict
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
    	permutationlist = get_permutations(WORDS_ALL_LOWER)
    	cipherdict = {}
    	numofwords = 0
...
if __name__ == '__main__':
    ...
    # Example test case
    message = SubMessage("yeah do you want to go to the bay and play with some lizards")
    permutation = "zxcvbnmasdfghjklqwertyuiop"
